...
public class computePhilhealthContributionTestWithMonthlyBasicSalary_Structure_10000 {
    ...
    @BeforeEach
    void setUp() {
        monthlyBasicSalary = new BigDecimal("10000.00");
        expectedResult = new BigDecimal("300.00").divide(BigDecimal.valueOf(2)); // // we divide as the payments are equally shared between the employee and employer.
        deductionService = new DeductionService();
    }

    @Test
    void philhealthComputationShouldBe300() {
