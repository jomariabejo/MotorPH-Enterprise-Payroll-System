...
@Getter
@Setter
public class PagibigContributionRateFormController {

    private PagibigContributionRateController rateController;
    private PagibigContributionRate rate;
    ...
    private void createRate() {
        PagibigContributionRate newRate = new PagibigContributionRate();
        mapFieldsToRate(newRate);
        
        rateController.getPayrollAdministratorNavigationController()
                .getMainViewController().getServiceFactory()
                .getPagibigContributionRateService().savePagibigContributionRate(newRate);

        CustomAlert alert = new CustomAlert(
                Alert.AlertType.INFORMATION,
                "Success",
                "Pagibig contribution rate created successfully."
        );
        alert.showAndWait();
    ...
    private void updateRate() {
        ...
        rateController.getPayrollAdministratorNavigationController()
                .getMainViewController().getServiceFactory()
                .getPagibigContributionRateService().updatePagibigContributionRate(rate);

        CustomAlert alert = new CustomAlert(
                Alert.AlertType.INFORMATION,
                "Success",
                "Pagibig contribution rate updated successfully."
        );
        alert.showAndWait();
    ...
    private void mapFieldsToRate(PagibigContributionRate rate) {
