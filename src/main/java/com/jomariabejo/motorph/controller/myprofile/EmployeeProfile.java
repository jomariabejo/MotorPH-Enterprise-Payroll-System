...
public class EmployeeProfile {
    ...
    private AllowanceService allowanceService = new AllowanceService();
    ...
    public EmployeeProfile() throws SQLException {
    }
        ...
        // editing employee record
            ...
            if (isEmployeeRecordConfirmed) {
                ...
                Employee employee = new Employee(
                        ...
                        tf_address.getText(),
                        tf_phoneNum.getText(),
                        EmployeeStatus.valueOf(tf_status.getText().toString()),
